defmodule SampleWeb.UserControllerTest do
  use SampleWeb.ConnCase

  import Sample.UsersFixtures

  @create_attrs %{name: "some name", address: "some address", phone: "some phone", email: "some email", birthday: ~D[2024-05-07], department: "some department", contract_type: 42, start_date: ~D[2024-05-07]}
