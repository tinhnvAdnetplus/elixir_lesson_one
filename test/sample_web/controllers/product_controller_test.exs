defmodule SampleWeb.ProductControllerTest do
  use SampleWeb.ConnCase

  import Sample.ProductsFixtures

  @create_attrs %{name: "some name", price: 42, stock: 42}
  @update_attrs %{name: "some updated name", price: 43, stock: 43}
